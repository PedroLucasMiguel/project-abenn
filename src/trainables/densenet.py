...
class DenseNet201ABNCF(TrainerFramework):
    def __init__(self, dataset_name: str) -> None:
        ...
        self.model = DenseNet201ABENN(self.baseline, self.n_classes, False)
...
class DenseNet201ABNCFGAP(TrainerFramework):
  def __init__(self, dataset_name: str) -> None:
    ...
    self.model = DenseNet201ABNGAP(self.baseline, self.n_classes, False)
