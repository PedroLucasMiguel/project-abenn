...
class CoatNetABNCFGAP(nn.Module):
    def __init__(self, baseline_model, n_classes:int, *args, **kwargs,) -> None:
        ...
        self.stage1 = copy.deepcopy(baseline_model.stages[0])

        self.attention_branch = nn.Sequential(
            copy.deepcopy(baseline_model.stages[1]),
            nn.AdaptiveAvgPool2d(56),
            #nn.BatchNorm2d(192),
            nn.Conv2d(192, n_classes, kernel_size=1, padding=0, bias=False),
        ...
        self.stage2 = copy.deepcopy(baseline_model.stages[1])
